...
(* === Reusable spec zeta-table bridge: v_ZETAS[i] == Spec.MLDSA.Ntt.zeta i ===
   ...
   to `Spec.MLDSA.Ntt.zeta` (a `match`), which `zeta_r` relates to the impl's
...
let lemma_v_zetas_eq_zeta (i: nat{1 <= i /\ i < 256})
    : Lemma (v (Hacspec_ml_dsa.Ntt.v_ZETAS.[ mk_usize i ] <: i32) == Spec.MLDSA.Ntt.zeta i)
  = lemma_vzetas_unfold ();
    FStar.Seq.Properties.lemma_seq_of_list_index zetas_list_dsa i;
    (match i with
     | 1 -> assert_norm (v (List.Tot.index zetas_list_dsa 1) == Spec.MLDSA.Ntt.zeta 1)
     | 2 -> assert_norm (v (List.Tot.index zetas_list_dsa 2) == Spec.MLDSA.Ntt.zeta 2)
     | 3 -> assert_norm (v (List.Tot.index zetas_list_dsa 3) == Spec.MLDSA.Ntt.zeta 3)
     | 4 -> assert_norm (v (List.Tot.index zetas_list_dsa 4) == Spec.MLDSA.Ntt.zeta 4)
     | 5 -> assert_norm (v (List.Tot.index zetas_list_dsa 5) == Spec.MLDSA.Ntt.zeta 5)
     | 6 -> assert_norm (v (List.Tot.index zetas_list_dsa 6) == Spec.MLDSA.Ntt.zeta 6)
     | 7 -> assert_norm (v (List.Tot.index zetas_list_dsa 7) == Spec.MLDSA.Ntt.zeta 7)
     | 8 -> assert_norm (v (List.Tot.index zetas_list_dsa 8) == Spec.MLDSA.Ntt.zeta 8)
     | 9 -> assert_norm (v (List.Tot.index zetas_list_dsa 9) == Spec.MLDSA.Ntt.zeta 9)
     | 10 -> assert_norm (v (List.Tot.index zetas_list_dsa 10) == Spec.MLDSA.Ntt.zeta 10)
     | 11 -> assert_norm (v (List.Tot.index zetas_list_dsa 11) == Spec.MLDSA.Ntt.zeta 11)
     | 12 -> assert_norm (v (List.Tot.index zetas_list_dsa 12) == Spec.MLDSA.Ntt.zeta 12)
     | 13 -> assert_norm (v (List.Tot.index zetas_list_dsa 13) == Spec.MLDSA.Ntt.zeta 13)
     | 14 -> assert_norm (v (List.Tot.index zetas_list_dsa 14) == Spec.MLDSA.Ntt.zeta 14)
     | 15 -> assert_norm (v (List.Tot.index zetas_list_dsa 15) == Spec.MLDSA.Ntt.zeta 15)
     | 16 -> assert_norm (v (List.Tot.index zetas_list_dsa 16) == Spec.MLDSA.Ntt.zeta 16)
     | 17 -> assert_norm (v (List.Tot.index zetas_list_dsa 17) == Spec.MLDSA.Ntt.zeta 17)
     | 18 -> assert_norm (v (List.Tot.index zetas_list_dsa 18) == Spec.MLDSA.Ntt.zeta 18)
     | 19 -> assert_norm (v (List.Tot.index zetas_list_dsa 19) == Spec.MLDSA.Ntt.zeta 19)
     | 20 -> assert_norm (v (List.Tot.index zetas_list_dsa 20) == Spec.MLDSA.Ntt.zeta 20)
     | 21 -> assert_norm (v (List.Tot.index zetas_list_dsa 21) == Spec.MLDSA.Ntt.zeta 21)
     | 22 -> assert_norm (v (List.Tot.index zetas_list_dsa 22) == Spec.MLDSA.Ntt.zeta 22)
     | 23 -> assert_norm (v (List.Tot.index zetas_list_dsa 23) == Spec.MLDSA.Ntt.zeta 23)
     | 24 -> assert_norm (v (List.Tot.index zetas_list_dsa 24) == Spec.MLDSA.Ntt.zeta 24)
     | 25 -> assert_norm (v (List.Tot.index zetas_list_dsa 25) == Spec.MLDSA.Ntt.zeta 25)
     | 26 -> assert_norm (v (List.Tot.index zetas_list_dsa 26) == Spec.MLDSA.Ntt.zeta 26)
     | 27 -> assert_norm (v (List.Tot.index zetas_list_dsa 27) == Spec.MLDSA.Ntt.zeta 27)
     | 28 -> assert_norm (v (List.Tot.index zetas_list_dsa 28) == Spec.MLDSA.Ntt.zeta 28)
     | 29 -> assert_norm (v (List.Tot.index zetas_list_dsa 29) == Spec.MLDSA.Ntt.zeta 29)
     | 30 -> assert_norm (v (List.Tot.index zetas_list_dsa 30) == Spec.MLDSA.Ntt.zeta 30)
     | 31 -> assert_norm (v (List.Tot.index zetas_list_dsa 31) == Spec.MLDSA.Ntt.zeta 31)
     | 32 -> assert_norm (v (List.Tot.index zetas_list_dsa 32) == Spec.MLDSA.Ntt.zeta 32)
     | 33 -> assert_norm (v (List.Tot.index zetas_list_dsa 33) == Spec.MLDSA.Ntt.zeta 33)
     | 34 -> assert_norm (v (List.Tot.index zetas_list_dsa 34) == Spec.MLDSA.Ntt.zeta 34)
     | 35 -> assert_norm (v (List.Tot.index zetas_list_dsa 35) == Spec.MLDSA.Ntt.zeta 35)
     | 36 -> assert_norm (v (List.Tot.index zetas_list_dsa 36) == Spec.MLDSA.Ntt.zeta 36)
     | 37 -> assert_norm (v (List.Tot.index zetas_list_dsa 37) == Spec.MLDSA.Ntt.zeta 37)
     | 38 -> assert_norm (v (List.Tot.index zetas_list_dsa 38) == Spec.MLDSA.Ntt.zeta 38)
     | 39 -> assert_norm (v (List.Tot.index zetas_list_dsa 39) == Spec.MLDSA.Ntt.zeta 39)
     | 40 -> assert_norm (v (List.Tot.index zetas_list_dsa 40) == Spec.MLDSA.Ntt.zeta 40)
     | 41 -> assert_norm (v (List.Tot.index zetas_list_dsa 41) == Spec.MLDSA.Ntt.zeta 41)
     | 42 -> assert_norm (v (List.Tot.index zetas_list_dsa 42) == Spec.MLDSA.Ntt.zeta 42)
     | 43 -> assert_norm (v (List.Tot.index zetas_list_dsa 43) == Spec.MLDSA.Ntt.zeta 43)
     | 44 -> assert_norm (v (List.Tot.index zetas_list_dsa 44) == Spec.MLDSA.Ntt.zeta 44)
     | 45 -> assert_norm (v (List.Tot.index zetas_list_dsa 45) == Spec.MLDSA.Ntt.zeta 45)
     | 46 -> assert_norm (v (List.Tot.index zetas_list_dsa 46) == Spec.MLDSA.Ntt.zeta 46)
     | 47 -> assert_norm (v (List.Tot.index zetas_list_dsa 47) == Spec.MLDSA.Ntt.zeta 47)
     | 48 -> assert_norm (v (List.Tot.index zetas_list_dsa 48) == Spec.MLDSA.Ntt.zeta 48)
     | 49 -> assert_norm (v (List.Tot.index zetas_list_dsa 49) == Spec.MLDSA.Ntt.zeta 49)
     | 50 -> assert_norm (v (List.Tot.index zetas_list_dsa 50) == Spec.MLDSA.Ntt.zeta 50)
     | 51 -> assert_norm (v (List.Tot.index zetas_list_dsa 51) == Spec.MLDSA.Ntt.zeta 51)
     | 52 -> assert_norm (v (List.Tot.index zetas_list_dsa 52) == Spec.MLDSA.Ntt.zeta 52)
     | 53 -> assert_norm (v (List.Tot.index zetas_list_dsa 53) == Spec.MLDSA.Ntt.zeta 53)
     | 54 -> assert_norm (v (List.Tot.index zetas_list_dsa 54) == Spec.MLDSA.Ntt.zeta 54)
     | 55 -> assert_norm (v (List.Tot.index zetas_list_dsa 55) == Spec.MLDSA.Ntt.zeta 55)
     | 56 -> assert_norm (v (List.Tot.index zetas_list_dsa 56) == Spec.MLDSA.Ntt.zeta 56)
     | 57 -> assert_norm (v (List.Tot.index zetas_list_dsa 57) == Spec.MLDSA.Ntt.zeta 57)
     | 58 -> assert_norm (v (List.Tot.index zetas_list_dsa 58) == Spec.MLDSA.Ntt.zeta 58)
     | 59 -> assert_norm (v (List.Tot.index zetas_list_dsa 59) == Spec.MLDSA.Ntt.zeta 59)
     | 60 -> assert_norm (v (List.Tot.index zetas_list_dsa 60) == Spec.MLDSA.Ntt.zeta 60)
     | 61 -> assert_norm (v (List.Tot.index zetas_list_dsa 61) == Spec.MLDSA.Ntt.zeta 61)
     | 62 -> assert_norm (v (List.Tot.index zetas_list_dsa 62) == Spec.MLDSA.Ntt.zeta 62)
     | 63 -> assert_norm (v (List.Tot.index zetas_list_dsa 63) == Spec.MLDSA.Ntt.zeta 63)
     | 64 -> assert_norm (v (List.Tot.index zetas_list_dsa 64) == Spec.MLDSA.Ntt.zeta 64)
     | 65 -> assert_norm (v (List.Tot.index zetas_list_dsa 65) == Spec.MLDSA.Ntt.zeta 65)
     | 66 -> assert_norm (v (List.Tot.index zetas_list_dsa 66) == Spec.MLDSA.Ntt.zeta 66)
     | 67 -> assert_norm (v (List.Tot.index zetas_list_dsa 67) == Spec.MLDSA.Ntt.zeta 67)
     | 68 -> assert_norm (v (List.Tot.index zetas_list_dsa 68) == Spec.MLDSA.Ntt.zeta 68)
     | 69 -> assert_norm (v (List.Tot.index zetas_list_dsa 69) == Spec.MLDSA.Ntt.zeta 69)
     | 70 -> assert_norm (v (List.Tot.index zetas_list_dsa 70) == Spec.MLDSA.Ntt.zeta 70)
     | 71 -> assert_norm (v (List.Tot.index zetas_list_dsa 71) == Spec.MLDSA.Ntt.zeta 71)
     | 72 -> assert_norm (v (List.Tot.index zetas_list_dsa 72) == Spec.MLDSA.Ntt.zeta 72)
     | 73 -> assert_norm (v (List.Tot.index zetas_list_dsa 73) == Spec.MLDSA.Ntt.zeta 73)
     | 74 -> assert_norm (v (List.Tot.index zetas_list_dsa 74) == Spec.MLDSA.Ntt.zeta 74)
     | 75 -> assert_norm (v (List.Tot.index zetas_list_dsa 75) == Spec.MLDSA.Ntt.zeta 75)
     | 76 -> assert_norm (v (List.Tot.index zetas_list_dsa 76) == Spec.MLDSA.Ntt.zeta 76)
     | 77 -> assert_norm (v (List.Tot.index zetas_list_dsa 77) == Spec.MLDSA.Ntt.zeta 77)
     | 78 -> assert_norm (v (List.Tot.index zetas_list_dsa 78) == Spec.MLDSA.Ntt.zeta 78)
     | 79 -> assert_norm (v (List.Tot.index zetas_list_dsa 79) == Spec.MLDSA.Ntt.zeta 79)
     | 80 -> assert_norm (v (List.Tot.index zetas_list_dsa 80) == Spec.MLDSA.Ntt.zeta 80)
     | 81 -> assert_norm (v (List.Tot.index zetas_list_dsa 81) == Spec.MLDSA.Ntt.zeta 81)
     | 82 -> assert_norm (v (List.Tot.index zetas_list_dsa 82) == Spec.MLDSA.Ntt.zeta 82)
     | 83 -> assert_norm (v (List.Tot.index zetas_list_dsa 83) == Spec.MLDSA.Ntt.zeta 83)
     | 84 -> assert_norm (v (List.Tot.index zetas_list_dsa 84) == Spec.MLDSA.Ntt.zeta 84)
     | 85 -> assert_norm (v (List.Tot.index zetas_list_dsa 85) == Spec.MLDSA.Ntt.zeta 85)
     | 86 -> assert_norm (v (List.Tot.index zetas_list_dsa 86) == Spec.MLDSA.Ntt.zeta 86)
     | 87 -> assert_norm (v (List.Tot.index zetas_list_dsa 87) == Spec.MLDSA.Ntt.zeta 87)
     | 88 -> assert_norm (v (List.Tot.index zetas_list_dsa 88) == Spec.MLDSA.Ntt.zeta 88)
     | 89 -> assert_norm (v (List.Tot.index zetas_list_dsa 89) == Spec.MLDSA.Ntt.zeta 89)
     | 90 -> assert_norm (v (List.Tot.index zetas_list_dsa 90) == Spec.MLDSA.Ntt.zeta 90)
     | 91 -> assert_norm (v (List.Tot.index zetas_list_dsa 91) == Spec.MLDSA.Ntt.zeta 91)
     | 92 -> assert_norm (v (List.Tot.index zetas_list_dsa 92) == Spec.MLDSA.Ntt.zeta 92)
     | 93 -> assert_norm (v (List.Tot.index zetas_list_dsa 93) == Spec.MLDSA.Ntt.zeta 93)
     | 94 -> assert_norm (v (List.Tot.index zetas_list_dsa 94) == Spec.MLDSA.Ntt.zeta 94)
     | 95 -> assert_norm (v (List.Tot.index zetas_list_dsa 95) == Spec.MLDSA.Ntt.zeta 95)
     | 96 -> assert_norm (v (List.Tot.index zetas_list_dsa 96) == Spec.MLDSA.Ntt.zeta 96)
     | 97 -> assert_norm (v (List.Tot.index zetas_list_dsa 97) == Spec.MLDSA.Ntt.zeta 97)
     | 98 -> assert_norm (v (List.Tot.index zetas_list_dsa 98) == Spec.MLDSA.Ntt.zeta 98)
     | 99 -> assert_norm (v (List.Tot.index zetas_list_dsa 99) == Spec.MLDSA.Ntt.zeta 99)
     | 100 -> assert_norm (v (List.Tot.index zetas_list_dsa 100) == Spec.MLDSA.Ntt.zeta 100)
     | 101 -> assert_norm (v (List.Tot.index zetas_list_dsa 101) == Spec.MLDSA.Ntt.zeta 101)
     | 102 -> assert_norm (v (List.Tot.index zetas_list_dsa 102) == Spec.MLDSA.Ntt.zeta 102)
     | 103 -> assert_norm (v (List.Tot.index zetas_list_dsa 103) == Spec.MLDSA.Ntt.zeta 103)
     | 104 -> assert_norm (v (List.Tot.index zetas_list_dsa 104) == Spec.MLDSA.Ntt.zeta 104)
     | 105 -> assert_norm (v (List.Tot.index zetas_list_dsa 105) == Spec.MLDSA.Ntt.zeta 105)
     | 106 -> assert_norm (v (List.Tot.index zetas_list_dsa 106) == Spec.MLDSA.Ntt.zeta 106)
     | 107 -> assert_norm (v (List.Tot.index zetas_list_dsa 107) == Spec.MLDSA.Ntt.zeta 107)
     | 108 -> assert_norm (v (List.Tot.index zetas_list_dsa 108) == Spec.MLDSA.Ntt.zeta 108)
     | 109 -> assert_norm (v (List.Tot.index zetas_list_dsa 109) == Spec.MLDSA.Ntt.zeta 109)
     | 110 -> assert_norm (v (List.Tot.index zetas_list_dsa 110) == Spec.MLDSA.Ntt.zeta 110)
     | 111 -> assert_norm (v (List.Tot.index zetas_list_dsa 111) == Spec.MLDSA.Ntt.zeta 111)
     | 112 -> assert_norm (v (List.Tot.index zetas_list_dsa 112) == Spec.MLDSA.Ntt.zeta 112)
     | 113 -> assert_norm (v (List.Tot.index zetas_list_dsa 113) == Spec.MLDSA.Ntt.zeta 113)
     | 114 -> assert_norm (v (List.Tot.index zetas_list_dsa 114) == Spec.MLDSA.Ntt.zeta 114)
     | 115 -> assert_norm (v (List.Tot.index zetas_list_dsa 115) == Spec.MLDSA.Ntt.zeta 115)
     | 116 -> assert_norm (v (List.Tot.index zetas_list_dsa 116) == Spec.MLDSA.Ntt.zeta 116)
     | 117 -> assert_norm (v (List.Tot.index zetas_list_dsa 117) == Spec.MLDSA.Ntt.zeta 117)
     | 118 -> assert_norm (v (List.Tot.index zetas_list_dsa 118) == Spec.MLDSA.Ntt.zeta 118)
     | 119 -> assert_norm (v (List.Tot.index zetas_list_dsa 119) == Spec.MLDSA.Ntt.zeta 119)
     | 120 -> assert_norm (v (List.Tot.index zetas_list_dsa 120) == Spec.MLDSA.Ntt.zeta 120)
     | 121 -> assert_norm (v (List.Tot.index zetas_list_dsa 121) == Spec.MLDSA.Ntt.zeta 121)
     | 122 -> assert_norm (v (List.Tot.index zetas_list_dsa 122) == Spec.MLDSA.Ntt.zeta 122)
     | 123 -> assert_norm (v (List.Tot.index zetas_list_dsa 123) == Spec.MLDSA.Ntt.zeta 123)
     | 124 -> assert_norm (v (List.Tot.index zetas_list_dsa 124) == Spec.MLDSA.Ntt.zeta 124)
     | 125 -> assert_norm (v (List.Tot.index zetas_list_dsa 125) == Spec.MLDSA.Ntt.zeta 125)
     | 126 -> assert_norm (v (List.Tot.index zetas_list_dsa 126) == Spec.MLDSA.Ntt.zeta 126)
     | 127 -> assert_norm (v (List.Tot.index zetas_list_dsa 127) == Spec.MLDSA.Ntt.zeta 127)
     | 128 -> assert_norm (v (List.Tot.index zetas_list_dsa 128) == Spec.MLDSA.Ntt.zeta 128)
     | 129 -> assert_norm (v (List.Tot.index zetas_list_dsa 129) == Spec.MLDSA.Ntt.zeta 129)
     | 130 -> assert_norm (v (List.Tot.index zetas_list_dsa 130) == Spec.MLDSA.Ntt.zeta 130)
     | 131 -> assert_norm (v (List.Tot.index zetas_list_dsa 131) == Spec.MLDSA.Ntt.zeta 131)
     | 132 -> assert_norm (v (List.Tot.index zetas_list_dsa 132) == Spec.MLDSA.Ntt.zeta 132)
     | 133 -> assert_norm (v (List.Tot.index zetas_list_dsa 133) == Spec.MLDSA.Ntt.zeta 133)
     | 134 -> assert_norm (v (List.Tot.index zetas_list_dsa 134) == Spec.MLDSA.Ntt.zeta 134)
     | 135 -> assert_norm (v (List.Tot.index zetas_list_dsa 135) == Spec.MLDSA.Ntt.zeta 135)
     | 136 -> assert_norm (v (List.Tot.index zetas_list_dsa 136) == Spec.MLDSA.Ntt.zeta 136)
     | 137 -> assert_norm (v (List.Tot.index zetas_list_dsa 137) == Spec.MLDSA.Ntt.zeta 137)
     | 138 -> assert_norm (v (List.Tot.index zetas_list_dsa 138) == Spec.MLDSA.Ntt.zeta 138)
     | 139 -> assert_norm (v (List.Tot.index zetas_list_dsa 139) == Spec.MLDSA.Ntt.zeta 139)
     | 140 -> assert_norm (v (List.Tot.index zetas_list_dsa 140) == Spec.MLDSA.Ntt.zeta 140)
     | 141 -> assert_norm (v (List.Tot.index zetas_list_dsa 141) == Spec.MLDSA.Ntt.zeta 141)
     | 142 -> assert_norm (v (List.Tot.index zetas_list_dsa 142) == Spec.MLDSA.Ntt.zeta 142)
     | 143 -> assert_norm (v (List.Tot.index zetas_list_dsa 143) == Spec.MLDSA.Ntt.zeta 143)
     | 144 -> assert_norm (v (List.Tot.index zetas_list_dsa 144) == Spec.MLDSA.Ntt.zeta 144)
     | 145 -> assert_norm (v (List.Tot.index zetas_list_dsa 145) == Spec.MLDSA.Ntt.zeta 145)
     | 146 -> assert_norm (v (List.Tot.index zetas_list_dsa 146) == Spec.MLDSA.Ntt.zeta 146)
     | 147 -> assert_norm (v (List.Tot.index zetas_list_dsa 147) == Spec.MLDSA.Ntt.zeta 147)
     | 148 -> assert_norm (v (List.Tot.index zetas_list_dsa 148) == Spec.MLDSA.Ntt.zeta 148)
     | 149 -> assert_norm (v (List.Tot.index zetas_list_dsa 149) == Spec.MLDSA.Ntt.zeta 149)
     | 150 -> assert_norm (v (List.Tot.index zetas_list_dsa 150) == Spec.MLDSA.Ntt.zeta 150)
     | 151 -> assert_norm (v (List.Tot.index zetas_list_dsa 151) == Spec.MLDSA.Ntt.zeta 151)
     | 152 -> assert_norm (v (List.Tot.index zetas_list_dsa 152) == Spec.MLDSA.Ntt.zeta 152)
     | 153 -> assert_norm (v (List.Tot.index zetas_list_dsa 153) == Spec.MLDSA.Ntt.zeta 153)
     | 154 -> assert_norm (v (List.Tot.index zetas_list_dsa 154) == Spec.MLDSA.Ntt.zeta 154)
     | 155 -> assert_norm (v (List.Tot.index zetas_list_dsa 155) == Spec.MLDSA.Ntt.zeta 155)
     | 156 -> assert_norm (v (List.Tot.index zetas_list_dsa 156) == Spec.MLDSA.Ntt.zeta 156)
     | 157 -> assert_norm (v (List.Tot.index zetas_list_dsa 157) == Spec.MLDSA.Ntt.zeta 157)
     | 158 -> assert_norm (v (List.Tot.index zetas_list_dsa 158) == Spec.MLDSA.Ntt.zeta 158)
     | 159 -> assert_norm (v (List.Tot.index zetas_list_dsa 159) == Spec.MLDSA.Ntt.zeta 159)
     | 160 -> assert_norm (v (List.Tot.index zetas_list_dsa 160) == Spec.MLDSA.Ntt.zeta 160)
     | 161 -> assert_norm (v (List.Tot.index zetas_list_dsa 161) == Spec.MLDSA.Ntt.zeta 161)
     | 162 -> assert_norm (v (List.Tot.index zetas_list_dsa 162) == Spec.MLDSA.Ntt.zeta 162)
     | 163 -> assert_norm (v (List.Tot.index zetas_list_dsa 163) == Spec.MLDSA.Ntt.zeta 163)
     | 164 -> assert_norm (v (List.Tot.index zetas_list_dsa 164) == Spec.MLDSA.Ntt.zeta 164)
     | 165 -> assert_norm (v (List.Tot.index zetas_list_dsa 165) == Spec.MLDSA.Ntt.zeta 165)
     | 166 -> assert_norm (v (List.Tot.index zetas_list_dsa 166) == Spec.MLDSA.Ntt.zeta 166)
     | 167 -> assert_norm (v (List.Tot.index zetas_list_dsa 167) == Spec.MLDSA.Ntt.zeta 167)
     | 168 -> assert_norm (v (List.Tot.index zetas_list_dsa 168) == Spec.MLDSA.Ntt.zeta 168)
     | 169 -> assert_norm (v (List.Tot.index zetas_list_dsa 169) == Spec.MLDSA.Ntt.zeta 169)
     | 170 -> assert_norm (v (List.Tot.index zetas_list_dsa 170) == Spec.MLDSA.Ntt.zeta 170)
     | 171 -> assert_norm (v (List.Tot.index zetas_list_dsa 171) == Spec.MLDSA.Ntt.zeta 171)
     | 172 -> assert_norm (v (List.Tot.index zetas_list_dsa 172) == Spec.MLDSA.Ntt.zeta 172)
     | 173 -> assert_norm (v (List.Tot.index zetas_list_dsa 173) == Spec.MLDSA.Ntt.zeta 173)
     | 174 -> assert_norm (v (List.Tot.index zetas_list_dsa 174) == Spec.MLDSA.Ntt.zeta 174)
     | 175 -> assert_norm (v (List.Tot.index zetas_list_dsa 175) == Spec.MLDSA.Ntt.zeta 175)
     | 176 -> assert_norm (v (List.Tot.index zetas_list_dsa 176) == Spec.MLDSA.Ntt.zeta 176)
     | 177 -> assert_norm (v (List.Tot.index zetas_list_dsa 177) == Spec.MLDSA.Ntt.zeta 177)
     | 178 -> assert_norm (v (List.Tot.index zetas_list_dsa 178) == Spec.MLDSA.Ntt.zeta 178)
     | 179 -> assert_norm (v (List.Tot.index zetas_list_dsa 179) == Spec.MLDSA.Ntt.zeta 179)
     | 180 -> assert_norm (v (List.Tot.index zetas_list_dsa 180) == Spec.MLDSA.Ntt.zeta 180)
     | 181 -> assert_norm (v (List.Tot.index zetas_list_dsa 181) == Spec.MLDSA.Ntt.zeta 181)
     | 182 -> assert_norm (v (List.Tot.index zetas_list_dsa 182) == Spec.MLDSA.Ntt.zeta 182)
     | 183 -> assert_norm (v (List.Tot.index zetas_list_dsa 183) == Spec.MLDSA.Ntt.zeta 183)
     | 184 -> assert_norm (v (List.Tot.index zetas_list_dsa 184) == Spec.MLDSA.Ntt.zeta 184)
     | 185 -> assert_norm (v (List.Tot.index zetas_list_dsa 185) == Spec.MLDSA.Ntt.zeta 185)
     | 186 -> assert_norm (v (List.Tot.index zetas_list_dsa 186) == Spec.MLDSA.Ntt.zeta 186)
     | 187 -> assert_norm (v (List.Tot.index zetas_list_dsa 187) == Spec.MLDSA.Ntt.zeta 187)
     | 188 -> assert_norm (v (List.Tot.index zetas_list_dsa 188) == Spec.MLDSA.Ntt.zeta 188)
     | 189 -> assert_norm (v (List.Tot.index zetas_list_dsa 189) == Spec.MLDSA.Ntt.zeta 189)
     | 190 -> assert_norm (v (List.Tot.index zetas_list_dsa 190) == Spec.MLDSA.Ntt.zeta 190)
     | 191 -> assert_norm (v (List.Tot.index zetas_list_dsa 191) == Spec.MLDSA.Ntt.zeta 191)
     | 192 -> assert_norm (v (List.Tot.index zetas_list_dsa 192) == Spec.MLDSA.Ntt.zeta 192)
     | 193 -> assert_norm (v (List.Tot.index zetas_list_dsa 193) == Spec.MLDSA.Ntt.zeta 193)
     | 194 -> assert_norm (v (List.Tot.index zetas_list_dsa 194) == Spec.MLDSA.Ntt.zeta 194)
     | 195 -> assert_norm (v (List.Tot.index zetas_list_dsa 195) == Spec.MLDSA.Ntt.zeta 195)
     | 196 -> assert_norm (v (List.Tot.index zetas_list_dsa 196) == Spec.MLDSA.Ntt.zeta 196)
     | 197 -> assert_norm (v (List.Tot.index zetas_list_dsa 197) == Spec.MLDSA.Ntt.zeta 197)
     | 198 -> assert_norm (v (List.Tot.index zetas_list_dsa 198) == Spec.MLDSA.Ntt.zeta 198)
     | 199 -> assert_norm (v (List.Tot.index zetas_list_dsa 199) == Spec.MLDSA.Ntt.zeta 199)
     | 200 -> assert_norm (v (List.Tot.index zetas_list_dsa 200) == Spec.MLDSA.Ntt.zeta 200)
     | 201 -> assert_norm (v (List.Tot.index zetas_list_dsa 201) == Spec.MLDSA.Ntt.zeta 201)
     | 202 -> assert_norm (v (List.Tot.index zetas_list_dsa 202) == Spec.MLDSA.Ntt.zeta 202)
     | 203 -> assert_norm (v (List.Tot.index zetas_list_dsa 203) == Spec.MLDSA.Ntt.zeta 203)
     | 204 -> assert_norm (v (List.Tot.index zetas_list_dsa 204) == Spec.MLDSA.Ntt.zeta 204)
     | 205 -> assert_norm (v (List.Tot.index zetas_list_dsa 205) == Spec.MLDSA.Ntt.zeta 205)
     | 206 -> assert_norm (v (List.Tot.index zetas_list_dsa 206) == Spec.MLDSA.Ntt.zeta 206)
     | 207 -> assert_norm (v (List.Tot.index zetas_list_dsa 207) == Spec.MLDSA.Ntt.zeta 207)
     | 208 -> assert_norm (v (List.Tot.index zetas_list_dsa 208) == Spec.MLDSA.Ntt.zeta 208)
     | 209 -> assert_norm (v (List.Tot.index zetas_list_dsa 209) == Spec.MLDSA.Ntt.zeta 209)
     | 210 -> assert_norm (v (List.Tot.index zetas_list_dsa 210) == Spec.MLDSA.Ntt.zeta 210)
     | 211 -> assert_norm (v (List.Tot.index zetas_list_dsa 211) == Spec.MLDSA.Ntt.zeta 211)
     | 212 -> assert_norm (v (List.Tot.index zetas_list_dsa 212) == Spec.MLDSA.Ntt.zeta 212)
     | 213 -> assert_norm (v (List.Tot.index zetas_list_dsa 213) == Spec.MLDSA.Ntt.zeta 213)
     | 214 -> assert_norm (v (List.Tot.index zetas_list_dsa 214) == Spec.MLDSA.Ntt.zeta 214)
     | 215 -> assert_norm (v (List.Tot.index zetas_list_dsa 215) == Spec.MLDSA.Ntt.zeta 215)
     | 216 -> assert_norm (v (List.Tot.index zetas_list_dsa 216) == Spec.MLDSA.Ntt.zeta 216)
     | 217 -> assert_norm (v (List.Tot.index zetas_list_dsa 217) == Spec.MLDSA.Ntt.zeta 217)
     | 218 -> assert_norm (v (List.Tot.index zetas_list_dsa 218) == Spec.MLDSA.Ntt.zeta 218)
     | 219 -> assert_norm (v (List.Tot.index zetas_list_dsa 219) == Spec.MLDSA.Ntt.zeta 219)
     | 220 -> assert_norm (v (List.Tot.index zetas_list_dsa 220) == Spec.MLDSA.Ntt.zeta 220)
     | 221 -> assert_norm (v (List.Tot.index zetas_list_dsa 221) == Spec.MLDSA.Ntt.zeta 221)
     | 222 -> assert_norm (v (List.Tot.index zetas_list_dsa 222) == Spec.MLDSA.Ntt.zeta 222)
     | 223 -> assert_norm (v (List.Tot.index zetas_list_dsa 223) == Spec.MLDSA.Ntt.zeta 223)
     | 224 -> assert_norm (v (List.Tot.index zetas_list_dsa 224) == Spec.MLDSA.Ntt.zeta 224)
     | 225 -> assert_norm (v (List.Tot.index zetas_list_dsa 225) == Spec.MLDSA.Ntt.zeta 225)
     | 226 -> assert_norm (v (List.Tot.index zetas_list_dsa 226) == Spec.MLDSA.Ntt.zeta 226)
     | 227 -> assert_norm (v (List.Tot.index zetas_list_dsa 227) == Spec.MLDSA.Ntt.zeta 227)
     | 228 -> assert_norm (v (List.Tot.index zetas_list_dsa 228) == Spec.MLDSA.Ntt.zeta 228)
     | 229 -> assert_norm (v (List.Tot.index zetas_list_dsa 229) == Spec.MLDSA.Ntt.zeta 229)
     | 230 -> assert_norm (v (List.Tot.index zetas_list_dsa 230) == Spec.MLDSA.Ntt.zeta 230)
     | 231 -> assert_norm (v (List.Tot.index zetas_list_dsa 231) == Spec.MLDSA.Ntt.zeta 231)
     | 232 -> assert_norm (v (List.Tot.index zetas_list_dsa 232) == Spec.MLDSA.Ntt.zeta 232)
     | 233 -> assert_norm (v (List.Tot.index zetas_list_dsa 233) == Spec.MLDSA.Ntt.zeta 233)
     | 234 -> assert_norm (v (List.Tot.index zetas_list_dsa 234) == Spec.MLDSA.Ntt.zeta 234)
     | 235 -> assert_norm (v (List.Tot.index zetas_list_dsa 235) == Spec.MLDSA.Ntt.zeta 235)
     | 236 -> assert_norm (v (List.Tot.index zetas_list_dsa 236) == Spec.MLDSA.Ntt.zeta 236)
     | 237 -> assert_norm (v (List.Tot.index zetas_list_dsa 237) == Spec.MLDSA.Ntt.zeta 237)
     | 238 -> assert_norm (v (List.Tot.index zetas_list_dsa 238) == Spec.MLDSA.Ntt.zeta 238)
     | 239 -> assert_norm (v (List.Tot.index zetas_list_dsa 239) == Spec.MLDSA.Ntt.zeta 239)
     | 240 -> assert_norm (v (List.Tot.index zetas_list_dsa 240) == Spec.MLDSA.Ntt.zeta 240)
     | 241 -> assert_norm (v (List.Tot.index zetas_list_dsa 241) == Spec.MLDSA.Ntt.zeta 241)
     | 242 -> assert_norm (v (List.Tot.index zetas_list_dsa 242) == Spec.MLDSA.Ntt.zeta 242)
     | 243 -> assert_norm (v (List.Tot.index zetas_list_dsa 243) == Spec.MLDSA.Ntt.zeta 243)
     | 244 -> assert_norm (v (List.Tot.index zetas_list_dsa 244) == Spec.MLDSA.Ntt.zeta 244)
     | 245 -> assert_norm (v (List.Tot.index zetas_list_dsa 245) == Spec.MLDSA.Ntt.zeta 245)
     | 246 -> assert_norm (v (List.Tot.index zetas_list_dsa 246) == Spec.MLDSA.Ntt.zeta 246)
     | 247 -> assert_norm (v (List.Tot.index zetas_list_dsa 247) == Spec.MLDSA.Ntt.zeta 247)
     | 248 -> assert_norm (v (List.Tot.index zetas_list_dsa 248) == Spec.MLDSA.Ntt.zeta 248)
     | 249 -> assert_norm (v (List.Tot.index zetas_list_dsa 249) == Spec.MLDSA.Ntt.zeta 249)
     | 250 -> assert_norm (v (List.Tot.index zetas_list_dsa 250) == Spec.MLDSA.Ntt.zeta 250)
     | 251 -> assert_norm (v (List.Tot.index zetas_list_dsa 251) == Spec.MLDSA.Ntt.zeta 251)
     | 252 -> assert_norm (v (List.Tot.index zetas_list_dsa 252) == Spec.MLDSA.Ntt.zeta 252)
     | 253 -> assert_norm (v (List.Tot.index zetas_list_dsa 253) == Spec.MLDSA.Ntt.zeta 253)
     | 254 -> assert_norm (v (List.Tot.index zetas_list_dsa 254) == Spec.MLDSA.Ntt.zeta 254)
     | 255 -> assert_norm (v (List.Tot.index zetas_list_dsa 255) == Spec.MLDSA.Ntt.zeta 255))
#pop-options
