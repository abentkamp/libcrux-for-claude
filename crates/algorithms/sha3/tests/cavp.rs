...
shake_test!(SHAKE128ShortMsg, libcrux_kats::sha3::shake128_short, shake128_ema);
shake_test!(SHAKE128LongMsg, libcrux_kats::sha3::shake128_long, shake128_ema);
shake_test!(SHAKE256ShortMsg, libcrux_kats::sha3::shake256_short, shake256_ema);
shake_test!(SHAKE256LongMsg, libcrux_kats::sha3::shake256_long, shake256_ema);
...
shake_vo_test!(SHAKE128VariableOut, libcrux_kats::sha3::shake128_variable_out, shake128_ema);
shake_vo_test!(SHAKE256VariableOut, libcrux_kats::sha3::shake256_variable_out, shake256_ema);
